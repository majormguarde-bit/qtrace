...
CSRF_TRUSTED_ORIGINS = config('CSRF_TRUSTED_ORIGINS', default='https://*.qtrace.ru,http://*.localhost,http://localhost,http://*.nip.io', cast=lambda v: [s.strip() for s in v.split(',')])
