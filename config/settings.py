...
# Session settings - увеличиваем время жизни сессии
SESSION_ENGINE = 'django.contrib.sessions.backends.db'
SESSION_COOKIE_AGE = 86400 * 30  # 30 дней
SESSION_COOKIE_HTTPONLY = True
SESSION_COOKIE_SECURE = False  # Set to True in production with HTTPS
SESSION_EXPIRE_AT_BROWSER_CLOSE = False
SESSION_SAVE_EVERY_REQUEST = True  # Обновляем время жизни при каждом запросе
...
# Logging configuration for admin password generation
LOGGING = {
    'version': 1,
    ...
    'handlers': {
        'admin_password_file': {
            ...
            'filename': os.path.join(BASE_DIR, 'logs', 'admin_password_log.log'),
    ...
    'loggers': {
        'admin_password_log': {
            'handlers': ['admin_password_file', 'console'],
            'level': 'INFO',
            'propagate': False,
        },
    },
