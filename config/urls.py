...
from customers.views import (
    ...
    superuser_template_save_diagram, superuser_template_add_stage_material, superuser_template_remove_stage_material,
    ...
    superuser_position_create_api,
    
    superuser_material_create_api, superuser_unit_create_api,
    
    superuser_export_template, superuser_import_template, superuser_template_export_n8n
)
...
urlpatterns = [
    ...
    path('superuser/templates/<int:template_id>/add-stage-material/<int:stage_id>/', superuser_template_add_stage_material, name='superuser_template_add_stage_material'),
    path('superuser/templates/<int:template_id>/remove-stage-material/<int:stage_id>/', superuser_template_remove_stage_material, name='superuser_template_remove_stage_material'),
    path('superuser/templates/<int:template_id>/export-n8n/', superuser_template_export_n8n, name='superuser_template_export_n8n'),
    ...
    path('superuser/positions/create-api/', superuser_position_create_api, name='superuser_position_create_api'),
    path('superuser/materials/create-api/', superuser_material_create_api, name='superuser_material_create_api'),
    path('superuser/units/create-api/', superuser_unit_create_api, name='superuser_unit_create_api'),
